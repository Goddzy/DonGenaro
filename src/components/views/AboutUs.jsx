    ...
    <Container className="my-5 mainSection">
      <Row>
        ...
        <Col md="6">
          ...
          <hr />
          <h2>
            <span className="badge bg-danger my-3">Desarrollador y diseñador</span>
          </h2>
          <p>
          ...
          <Row className="my-5">
            ...
            <Col xs="4" as={Link} to="https://www.instagram.com" target="_blank"  className="fs-1 text-dark"><FontAwesomeIcon icon={faInstagram} /></Col>
            <Col xs="4" as={Link} to="https://gmail.com" target="_blank"  className="fs-1 text-dark"><FontAwesomeIcon icon={faGoogle} /></Col>
          </Row>
        </Col>
      </Row>
    </Container>
